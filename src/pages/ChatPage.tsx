...
import { ArrowLeft, Video, VideoOff, Clock, Save, AlertCircle, Play, Pause } from 'lucide-react'
              ...
              <div className="grid lg:grid-cols-5 gap-8">
                ...
                <div className="space-y-6">
                  <div className="glass-strong rounded-xl p-6 border border-slate-700/30 card-3d">
                    <h3 className="font-semibold mb-4 text-purple-400">Interview Controls</h3>
